...
const LoginForm = ({handleSetAction}: LoginFormProps) => {
    return(
        <Card className="border-[#121212]">
          <TextInput label="E-mail" labelClassNames="text-black" placeholder="E-mail" type="email" iconLeft="uil:envelope-alt"/>
          <TextInput label="Senha" labelClassNames="text-black" placeholder="Senha" type="password" iconLeft="uil:key-skeleton-alt"/>
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <Button iconLeft="uil:facebook-f" variant="secondary" className="rounded-md">
